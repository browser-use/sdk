---
title: "Basics"
description: "Attach reusable task instructions to an open-source Browser Use agent."
icon: "wand-magic"
---

To learn more visit [Skills - Concepts](/cloud/legacy/skills).
...
<Note>
Get your API key on [cloud](https://cloud.browser-use.com/new-api-key). See
[pricing](https://browser-use.com/pricing) for current plans and credits.
</Note>
