...
CodeAgent writes and executes Python code locally with browser automation capabilities. It is designed for repetitive data extraction tasks where the agent can write reusable functions.
