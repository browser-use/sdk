...
Browser Use supports multiple LLM providers. Check each provider's docs to see
...
[model benchmarks](https://browser-use.com/posts/speed-matters) for measured
comparisons.
...
Get your API key from [Browser Use Cloud](https://cloud.browser-use.com/new-api-key).

#### Pricing

See [current pricing](https://browser-use.com/pricing) for model token rates,
plans, and credits.
