...
[model benchmarks](https://browser-use.com/posts/speed-matters/) and
[current pricing](https://browser-use.com/pricing), then get your API key
[here](https://cloud.browser-use.com/new-api-key).
</Note>
...
We recommend starting with `ChatBrowserUse`, which is optimized for browser
automation tasks. See the [model benchmarks](https://browser-use.com/posts/speed-matters/)
and [current pricing](https://browser-use.com/pricing). Get your API key
[here](https://cloud.browser-use.com/new-api-key).
</Callout>
...
See [Supported Models](/open-source/supported-models) for more.
...
<Note> Custom browsers can be configured in one line. Check out <a href="/open-source/customize/browser/basics">browsers</a> for more. </Note>
...
To run in production with authentication, add `@sandbox` to your function:
...
See [Browser Use Cloud](/cloud/quickstart) for how to sync your cookies to the cloud.
