...
description: "Control hosted cloud browser infrastructure for AI agents through the SDK, REST, or CDP."
icon: rocket
---

Browser Infrastructure is hosted cloud browser infrastructure for AI agents,
controlled through the SDK, REST, or CDP. A browser's **CDP URL** is a WebSocket
endpoint for remotely controlling Chrome.
