...
<img src="/images/intro-cloud-white.svg" alt="Browser Use Cloud" noZoom className="block dark:hidden" />
<img src="/images/intro-cloud-black.svg" alt="Browser Use Cloud" noZoom className="hidden dark:block" />
