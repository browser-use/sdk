---
title: Introduction
description: Browser Use Cloud is an SDK and API for AI-powered browser automation. State-of-the-art in speed and accuracy, with stealth browsers, CAPTCHA solving, proxies, and scalable infrastructure.
icon: house
mode: wide
---
