...
<CardGroup cols={2}>
  <Card title="Stealth Browsers" icon="shield-halved" href="/cloud/guides/proxies-and-stealth">
    Anti-detect, CAPTCHA solving, proxies in 195+ countries.
  </Card>
  <Card title="Browser Use LLM" icon="brain" href="/cloud/pricing">
  ...
  <Card title="Infinite Scale" icon="arrow-up-right-dots" href="/cloud/guides/tasks">
...
<CardGroup cols={2}>
  <Card title="LLM Quickstart" icon="brain" href="/cloud/llm-quickstart">
    Paste one blob into your AI editor. Your agent knows the entire API.
  </Card>
  <Card title="Overview" icon="lightbulb" href="/cloud/guides/overview">
