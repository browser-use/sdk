---
title: Introduction
description: Browser Use Cloud is an API for AI-powered browser automation. The fastest web agent — 6x lower latency, 15x cheaper, with stealth browsers and CAPTCHA solving built in.
icon: house
mode: wide
---
