---
title: Quickstart
description: "State-of-the-art AI browser agents with stealth browsers, CAPTCHA solving, residential proxies, and managed infrastructure."
...
<Accordion title="Copy setup prompt for Claude Code, Codex, Cursor..." icon="clipboard">
````markdown
