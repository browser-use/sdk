...
| Model | API String |
| ----- | ---------- |
| Browser Use 2.0 (default) | `browser-use-2.0` |
| O3 | `o3` |
| Gemini Flash Latest | `gemini-flash-latest` |
| Gemini Flash Lite Latest | `gemini-flash-lite-latest` |
| Claude Sonnet 4.5 | `claude-sonnet-4-5-20250929` |

See [pricing](https://browser-use.com/pricing) for current model rates.
...
| `thinking_level` / `thinkingLevel` | `str` | Provider reasoning depth in the Python / TypeScript SDKs. REST JSON uses `thinkingLevel`; see [Thinking levels](/cloud/agent/thinking-levels). |
