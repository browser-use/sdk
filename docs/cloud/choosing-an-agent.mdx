...
| Speed                  | slower, more thorough    | **fastest**                          | in between                        |
| Cost level             | \$\$\$                      | \$\$                                   | \$                                 |
...
Measured with the same model — Claude Opus 4.7 — across the last 30 days of production usage, the typical customer's successful task costs \$0.70 on V2, \$0.87 on V3, and \$1.64 on V4, taking about 1, 2, and 5 minutes respectively. V4 costs more per task because customers hand it bigger jobs.
