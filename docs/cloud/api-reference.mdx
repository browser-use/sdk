---
title: API Reference
description: REST API reference for Browser Use Cloud — the fastest AI browser automation API. 20 steps per minute, stealth infrastructure, and custom models 15x cheaper than GPT-4o.
mode: wide
---
