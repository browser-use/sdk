...
See the full [Workspaces guide](/cloud/agent/workspaces) for CRUD, file management, and more.
...
<CardGroup cols={2}>
  ...
  <Card title="Workspaces Guide" icon="folder" href="/cloud/agent/workspaces">
    Persistent file storage across sessions.
  </Card>
  <Card title="Agent Tasks" icon="play" href="/cloud/agent/quickstart">
    Task guide.
  </Card>
</CardGroup>

<Note>
  The BU Agent API interface may change.
</Note>
