...
Create an API key from [Settings → API Keys](https://cloud.browser-use.com/settings?tab=api-keys&new=1).

Running Hermes without a human? Use [x402 pay-per-request](/cloud/guides/x402) instead; it needs no account or API key.
