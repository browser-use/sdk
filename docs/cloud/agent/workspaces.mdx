...
A workspace is a persistent storage container that lives across sessions. Upload input data before a task starts, or retrieve output files after it completes.
