...
The following Browser Use-hosted models have published token pricing:
...
rollout and configured provider key. An accepted ID does not guarantee access
to every upstream provider. Experimental models are not recommended as a
...
| OpenAI | `gpt-5.5`, `gpt-5.6`, `gpt-5.6-sol`, `gpt-5.6-terra`, `gpt-5.6-luna`, `gpt-6-astra` | OpenAI |
...
| DeepSeek (experimental) | `deepseek-v4-flash-vision` | — |
| Moonshot AI | `kimi-k3` | — |
| MiniMax | `minimax-m3` | — |
