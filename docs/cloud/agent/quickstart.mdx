...
The SDK is a thin wrapper with polling around the [API v3 Reference](/cloud/api-reference). `client.run()` creates a session, polls until completion, and parses the output.
