...
The SDK auto-retries 429 responses with exponential backoff (up to 10s). If you're consistently hitting limits, you may need to upgrade your plan for more concurrent sessions. See [Pricing](/cloud/pricing).
