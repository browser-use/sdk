...
<Note>
  Requires a 1Password service account connected to Browser Use Cloud. See [Authentication & 2FA](/guides/authentication#1password-integration) for setup steps.
</Note>
